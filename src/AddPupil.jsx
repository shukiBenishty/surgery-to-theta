...
class AddPupil extends React.Component<{}, State> {
  ...
  authorityChanged = (authority) => {
    ...
    let _state = {};
    if (this.state.componentState === 'edit') {
      _state.disabledUnit = false;
      _state.filterdUnits = _units;
      _state.filterdGroups = _groups;
      _state.selectedAuthority = authority;
      _state.selectedUnit = 'אנא בחר מוסד';
      _state.selectedGroup = 'אנא בחר כיתה';
    }else {
      _state.disabledUnit = true;
      _state.filterdUnits = _units;
      _state.filterdGroups = _groups;
      _state.selectedAuthority = authority;
    }
  ...
  groupChanged = (group) => {
    ...
    //this.state.pupil.groupName = group.name;
    this.setState({
      selectedGroup: group
    });
  }
                              ...
                              <Row>
                                <Col md='4' className='pr-1 text-left'>
                                  <div>
                                    ...
                                    <AutoComplete onChange={::this.authorityChanged}
                                      lable="רשות" data={this.state.authorities}
                                      groupBy="region"
                                ...
                                <Col md='4' className='pr-1 text-left'>
                                  ...
                                  <AutoComplete onChange={::this.unitChanged}
                                    lable="מוסד" data={this.state.filterdUnits}
                                ...
                                <Col md='4' className='pr-1 text-left'>
                                  <label className='form-control-label'>כיתה</label>
                                   <AutoComplete onChange={::this.groupChanged}
                                     lable="כיתה" data={this.state.filterdGroups}
